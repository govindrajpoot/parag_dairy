...
async function testDistributorEndpoints() {
  try {
    ...
    const signinResponse = await fetch('http://localhost:80/api/auth/signin', {
      method: 'POST',
      headers: {
    ...
    const getAllResponse = await fetch('http://localhost:80/api/distributors', {
      method: 'GET',
      headers: {
    ...
    const createDistributorResponse = await fetch('http://localhost:80/api/auth/signup', {
      method: 'POST',
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json',
    ...
    const getByIdResponse = await fetch(`http://localhost:80/api/distributors/${distributorId}`, {
      method: 'GET',
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json',
    ...
    const updateResponse = await fetch(`http://localhost:80/api/distributors/${distributorId}`, {
      method: 'PUT',
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json',
    ...
    const deleteResponse = await fetch(`http://localhost:80/api/distributors/${distributorId}`, {
      method: 'DELETE',
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json',
    ...
    const unauthorizedResponse = await fetch('http://localhost:80/api/distributors', {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
      }
    ...
    const invalidIdResponse = await fetch('http://localhost:80/api/distributors/99999', {
      method: 'GET',
      headers: {
        'Authorization': `Bearer ${token}`,
        'Content-Type': 'application/json',
